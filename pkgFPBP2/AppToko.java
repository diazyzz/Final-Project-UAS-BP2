                    ...
                    do {
                        ...
                        switch (pilih4) {
                            case 1:
                                ...
                                boolean ada = false;
                                if (namaBarang.equalsIgnoreCase(brg1.getNama())) {
                                    ada = true;
                                    brg1.setHarga(hargaBaru);
                                } else if (namaBarang.equalsIgnoreCase(brg2.getNama())) {
                                    ada = true;
                                    brg2.setHarga(hargaBaru);
                                } else if (namaBarang.equalsIgnoreCase(brg3.getNama())) {
                                    ada = true;
                                    brg3.setHarga(hargaBaru);
                                } else if (namaBarang.equalsIgnoreCase(brg4.getNama())) {
                                    ada = true;
                                    brg4.setHarga(hargaBaru);

                                } else if (namaBarang.equalsIgnoreCase(brg5.getNama())) {
                                    ada = true;
